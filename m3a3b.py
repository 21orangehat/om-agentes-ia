...
def main() -> None:
    ...
    cliente2_info: Cliente = Cliente(id='002', nome='Symone Rialdo', compras=compras, novo=False)
    ...
    while True:
        try:
            ...
            result: RunResult = Runner.run_sync(starting_agent=agent, input=user_input, context=cliente2_info, session=session)
