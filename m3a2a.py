...
from tools import get_client_recent_purchases, get_client_info
...
def main() -> None:
    agent: Agent = get_agent(
        ...
        instructions='Você é um assistente inteligente qu eajuda clientes com dúvidas ou problemas sobre suas compras. Seja educado e amigável, chamando o cliente sempre pelo nome e sempre direto ao ponto.',
    ...
    cliente_info: Cliente = Cliente(id='001', nome='Ray Sychev', compras=compras)
    ...
    while True:
        try:
            ...
            result: RunResult = Runner.run_sync(starting_agent=agent, input=user_input, context=cliente_info)
